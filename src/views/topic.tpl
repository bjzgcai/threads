...
<div class="flex-fill zgci-topic-page" itemid="{url}" itemscope itemtype="https://schema.org/DiscussionForumPosting">
	...
	<div class="d-flex flex-column gap-3">
		<section class="zgci-topic-masthead d-flex gap-3 flex-wrap flex-column flex-md-row {{{ if config.theme.centerHeaderElements }}}justify-content-center{{{ else }}}justify-content-between{{{ end }}}">
			<div class="d-flex flex-column gap-3 flex-md-shrink-50 zgci-topic-title-block">
		...
		<div class="row mb-4 mb-lg-0">
			<div class="topic {{{ if widgets.sidebar.length }}}col-lg-9 col-sm-12{{{ else }}}col-lg-12{{{ end }}}">
				...
				<div class="d-flex gap-0 gap-lg-5 zgci-topic-reading-shell">
					<div class="posts-container zgci-posts-container" style="min-width: 0;">
						<ul component="topic" class="posts timeline list-unstyled p-0 py-3 zgci-posts-list" style="min-width: 0;" data-tid="{tid}" data-cid="{cid}">
						{{{ each posts }}}
