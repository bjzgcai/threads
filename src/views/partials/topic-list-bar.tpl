		...
		<div class="d-flex flex-row p-2 card card-header gap-1 border rounded w-100 align-items-center">
			<div component="category/controls" class="d-flex flex-wrap align-items-stretch me-auto mb-0 gap-2">
				...
				<div class="d-flex align-items-center gap-1">
					<button type="button" component="topic/select-all" class="btn btn-ghost btn-sm ff-secondary d-flex gap-2 align-items-center h-100">
						<i class="fa fa-fw fa-check-square-o text-primary"></i>
						<span class="visible-md-inline visible-lg-inline fw-semibold">全选</span>
					</button>
					<button type="button" component="topic/select-none" class="btn btn-ghost btn-sm ff-secondary d-flex gap-2 align-items-center h-100">
						<i class="fa fa-fw fa-square-o text-primary"></i>
						<span class="visible-md-inline visible-lg-inline fw-semibold">清空</span>
					</button>
				</div>
				{{{ end }}}
