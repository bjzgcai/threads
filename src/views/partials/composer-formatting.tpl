<div class="d-flex justify-content-between gap-2 align-items-center formatting-bar m-0 zgci-composer-formatting">
	...
	<div class="d-flex align-items-center gap-1">
		...
		<button class="btn btn-sm btn-link py-2 text-body fw-semibold text-nowrap" data-action="preview" aria-label="[[modules:composer.show-preview]]" aria-controls="composer-preview-panel">
			<i class="fa fa-eye"></i>
		...
		<button class="btn btn-sm btn-link py-2 text-body fw-semibold text-nowrap" data-action="help" aria-label="[[modules:composer.help]]">
