...
module.exports = function (app, name, middleware, controllers) {
	...
	helpers.setupAdminPageRoute(app, `/${name}/dashboard/daily-report`, middlewares, controllers.admin.dailyReport.get);
	...
	helpers.setupAdminPageRoute(app, `/${name}/manage/skills`, middlewares, controllers.admin.skills.get);
